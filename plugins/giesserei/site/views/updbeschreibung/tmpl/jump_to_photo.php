...
<div class="component">
    ...
    <div style="margin-top:25px;">
        <?php echo "<input type=\"button\" value=\"Profil-Seite des Forums\" onclick=\"window.location.href='/aktuell/forum/profile?view=user&layout=edit&userid=" . $this->item->userid . "'\" />" ?>
