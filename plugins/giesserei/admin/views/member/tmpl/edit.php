        ...
        <div class="width-40 fltrt">
            ...
            <fieldset class="panelform">
                <table>
                    <tr>
                        <td>Kinder:</td>
                        <td><strong><?php echo $this->item->kinder; ?></strong></td>
                    </tr>
                    <tr>
                        <td>E-Mail:</td>
                        <td><strong><?php echo $this->item->email; ?></strong></td>
                    </tr>
                    <tr>
                        <td>Gruppen:</td>
                        <td><strong><?php echo $this->item->gruppen; ?></strong></td>
                    </tr>
                    <tr>
                        <td>Geburtstag:</td>
                        <td><strong><?php
                    ...
                    <tr>
                        <td>Geschlecht:</td>
                        <td>
                            <strong><?php if ($this->item->gender == 1) echo "männlich"; elseif ($this->item->gender == 2) echo "weiblich";
                                else echo "unbekannt"; ?></strong></td>
                    </tr>
                    <tr>
                        <td colspan="2"><?php
