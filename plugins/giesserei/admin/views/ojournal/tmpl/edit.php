...
<form action="<?php echo JRoute::_('index.php?option=com_giesserei&id=' . (int)$this->item->id); ?>" method="post"
    ...
    <div class="width-60 fltlft">
        <fieldset class="adminform">
            ...
            <table class="admintable">
                ...
                <tr>
                    <td width="100" align="right" class="key">
                        <?php echo $this->form->getLabel('titel') . "</td><td>";
                        echo $this->form->getInput('titel');
                        ?>
                    </td>
                </tr>
                ...
                <tr>
                    <td width="100" align="right" class="key">
                        ...
                        $typen = $this->get('ObjectjournalClasses');
                        if (count($typen) > 0):
    ...
    <input type="hidden" name="jform[objektid]" value="<?php echo $this->item->objektid; ?>"/>
